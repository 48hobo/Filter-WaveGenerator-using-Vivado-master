...
HD_PWD='D:/Xilinx/VivadoProjects/Filter_WaveGenerator/Filter_WaveGenerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Filter_WaveGenerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Filter_WaveGenerator.tcl
