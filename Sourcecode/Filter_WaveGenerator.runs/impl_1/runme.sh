...
HD_PWD='D:/Xilinx/VivadoProjects/Filter_WaveGenerator/Filter_WaveGenerator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Filter_WaveGenerator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Filter_WaveGenerator.tcl -notrace
